        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-start gap-3 py-2">
            ...
            <label htmlFor="terms" className="text-xs text-warm-dim font-inter leading-relaxed cursor-pointer select-none">
              Eu li e aceito os <a href="#" className="text-gold hover:underline">Termos de Serviço</a> e concordo com a <a href="#" className="text-gold hover:underline">Política de Reembolso</a> (Nenhum reembolso é garantido para itens virtuais).
            </label>
          </div>
